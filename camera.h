...
class camera {
    ...
    vec3 vup = vec3(0,1,0); //The camera's vertical up direction, manages the roll
    ...
    ray get_ray(int i, int j) const {
        //Construct a ray from the origin directed at a random point close to the location of the pixel sample i, j
    ...
    //Returns the vector to a random point in a square half a pixel around the center of the pixel sample
